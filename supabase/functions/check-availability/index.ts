...
serve(async (req) => {
  ...
  try {
    ...
    // Get calendar connections for all participants (both Google and Microsoft)
    ...
    for (const connection of connections || []) {
      ...
      try {
        ...
        console.log(`Checking ${connection.provider} calendars for user ${connection.user_id}:`, calendarIds);
